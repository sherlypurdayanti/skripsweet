...
<head>
    ...
    <style>
        ...
        .sidebar .nav-link.toggle[aria-expanded="true"]::after {
            transform: rotate(180deg); /* ke atas */
        }
...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm" style="margin-left: 250px;">
  <div class="container-fluid">
    <a class="navbar-brand" href="dashboard.php">Sistem Penilaian Kinerja Karyawan Menggunakan 360 Derajat</a>
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a href="../Karyawan/karyawan.php" class="nav-link">
                <i class="bi bi-people"></i> <span class="menu-text">Data Karyawan</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="../Penilaian/penilaian.php" class="nav-link">
        ...
        <li class="nav-item">
            <a href="../Sub_Kriteria/subkriteria.php" class="nav-link">
