...
$generatedUsername = 'user_' . generateRandomString(4);
    ...
    <div class="card shadow-sm mt-4">
      ...
      <div class="card-body">
        ...
        <table id="tabelKaryawan" class="table table-bordered">
          ...
          <tbody>
            <?php
            $query = mysqli_query($koneksi, "SELECT * FROM tabel_karyawan WHERE perusahaan = 'PT. Berkah Sejahtera Investama'");
            $no = 1;
          ...
          <form action="tambah_karyawan.php" method="POST">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="username" value="<?php echo $generatedUsername; ?>" readonly>
              </div>

              <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <input type="text" class="form-control" id="password" name="password" value="<?php echo $generatedPassword; ?>" readonly>
              </div>
