...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a href="/skripsweet/bestama/dashboard.php" class="nav-link">
                    <i class="bi bi-speedometer2"></i> <span class="menu-text">Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/bestama/karyawan/karyawan.php" class="nav-link">
                    <i class="bi bi-people"></i> <span class="menu-text">Data Karyawan</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/bestama/penilaian/penilaian.php" class="nav-link">
                    <i class="bi bi-card-checklist"></i> <span class="menu-text">Data Penilaian</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/bestama/kriteria/kriteria.php" class="nav-link">
                    <i class="bi bi-funnel"></i> <span class="menu-text">Data Kriteria</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/bestama/sub_kriteria/subkriteria.php" class="nav-link">
                    <i class="bi bi-sliders"></i> <span class="menu-text">Data Sub Kriteria</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/bestama/hasil/hasil.php" class="nav-link">
                    <i class="bi bi-bar-chart-line"></i> <span class="menu-text">Rekomendasi Keputusan</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/bestama/hasil/hasil.php" class="nav-link">
