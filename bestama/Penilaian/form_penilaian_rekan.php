...
$kriteria = mysqli_query($koneksi, "SELECT * FROM kriteria WHERE aktif = 1 AND tipe_penilai = 'rekan'");
?>
<!DOCTYPE html>
<html>
<head>
  <title>Form Penilaian Rekan Kerja</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-5">
  <h4>Form Penilaian oleh Rekan Kerja</h4>
  <form action="simpan_penilaian_rekan.php" method="POST">
