...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a href="/skripsweet/admin/dashboard.php" class="nav-link">
                    <i class="bi bi-speedometer2"></i> <span class="menu-text">Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/admin/karyawan/karyawan.php" class="nav-link">
                    <i class="bi bi-people"></i> <span class="menu-text">Data Karyawan</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/admin/penilaian/penilaian.php" class="nav-link">
                    <i class="bi bi-card-checklist"></i> <span class="menu-text">Data Penilaian</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/admin/kriteria/kriteria.php" class="nav-link">
                    <i class="bi bi-funnel"></i> <span class="menu-text">Data Kriteria</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/admin/sub_kriteria/subkriteria.php" class="nav-link">
                    <i class="bi bi-sliders"></i> <span class="menu-text">Data Sub Kriteria</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/skripsweet/admin/hasil/hasil.php" class="nav-link">
